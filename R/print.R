...
print.enpls.ad = function(x, ...) {
  ...
  cat('applicability domain by Ensemble Partial Least Squares\n')
  cat('---\n')
  cat('STD value for training set :\n')
  print(x$STD.cv)
  cat('---\n')
  cat('STD value for test set :\n')
  print(x$STD.te)
  cat('---\n')
  cat('absolute prediction error of training set :\n')
  print(x$error.cv)
  cat('---\n')
  cat('absolute prediction error of test set :\n')
  print(x$error.te)
